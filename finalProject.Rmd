...
tibble(
  Variable  = c("Population Density", "Street Intersection Density", "Economic Opportunity"),
  r         = round(c(ct_pop$estimate, ct_int$estimate, ct_opp$estimate), 3),
  `R²`      = round(c(ct_pop$estimate^2, ct_int$estimate^2, ct_opp$estimate^2), 3),
